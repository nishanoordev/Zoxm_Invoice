...
set(NODE_EXECUTABLE /opt/homebrew/bin/node CACHE PATH "Path to node executable" FORCE)
message(STATUS "[Worklets] Using hardcoded NODE_EXECUTABLE: ${NODE_EXECUTABLE}")
